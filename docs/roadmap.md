...
| maybe add a setup (checkbox) to enable or disable cutting layer after it have been placed on the target layer position            | ⬜      |
| review the coin's scale related to the cards                                                                                      | ⬜      |
